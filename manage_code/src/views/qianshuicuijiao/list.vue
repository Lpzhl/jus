	...
	<div>
		<div class="center_view">
			<div class="list_search_view">
				...
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('qianshuicuijiao','新增')">
						新增
					</el-button>
					<el-button class="del_btn" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('qianshuicuijiao','删除')">
						删除
					</el-button>
				</div>
			</div>
			<el-table
				...
				ref="table"
				v-if="btnAuth('qianshuicuijiao','查看')"
				:data="list"
				...
				<el-table-column label="申报回执" min-width="140" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
						<el-button v-if="scope.row.shenbaohuizhi" size="small" @click="download(scope.row.shenbaohuizhi)">下载</el-button>
				...
				<el-table-column min-width="140"
					...
					label="催缴时间">
					<template #default="scope">
						{{scope.row.cuijiaoshijian}}
					</template>
				</el-table-column>
				<el-table-column label="操作" class-name="operation-cell" width="300"  :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
						<el-button class="view_btn" type="info" v-if=" btnAuth('qianshuicuijiao','查看')" @click="infoClick(scope.row.id)">
							详情
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id,scope.row)" v-if=" btnAuth('qianshuicuijiao','修改')">
							修改						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id,scope.row)"  v-if="btnAuth('qianshuicuijiao','删除')">
							删除						</el-button>
					</template>
				</el-table-column>
			</el-table>
