					...
					<el-col :span="8">
						<el-form-item label="企业名称" prop="qiyemingcheng">
							<el-input class="list_inp" v-model="form.qiyemingcheng" placeholder="企业名称"
								type="text" :readonly="!isAdd||disabledForm.qiyemingcheng||form.id?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="8">
						<el-form-item label="企业电话" prop="qiyedianhua">
							<el-input class="list_inp" v-model="form.qiyedianhua" placeholder="企业电话"
                                type="text"
								:readonly="!isAdd||disabledForm.qiyedianhua?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="8">
						<el-form-item label="统一社会信用代码" prop="tongyishehuixinyongdaima">
							<el-input class="list_inp" v-model="form.tongyishehuixinyongdaima" :readonly="true" placeholder="统一社会信用代码" />
						</el-form-item>
					</el-col>
					<el-col :span="8">
