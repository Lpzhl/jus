		...
		<el-dialog modal-class="edit_form_modal" class="edit_form" v-model="formVisible" :title="formTitle" width="90%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" :rules="rules">
				<el-row >
					...
					<el-col :span="8">
						<el-form-item label="作废时间" prop="zuofeishijian">
							<el-date-picker
								class="list_date"
								v-model="form.zuofeishijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.zuofeishijian?true:false"
								placeholder="请选择作废时间" />
						</el-form-item>
					</el-col>
					<el-col :span="8">
					...
					<el-col :span="8">
						<el-form-item prop="fapiaotupian"
									  label="发票图片"
						>
							<uploads
