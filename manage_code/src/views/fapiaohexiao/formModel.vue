		...
		<el-dialog modal-class="edit_form_modal" class="edit_form" v-model="formVisible" :title="formTitle" width="90%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" :rules="rules">
				<el-row >
					...
					<el-col :span="8">
						<el-form-item label="核销时间" prop="hexiaoshijian">
							<el-date-picker
								class="list_date"
								v-model="form.hexiaoshijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.hexiaoshijian?true:false"
								placeholder="请选择核销时间" />
						</el-form-item>
					</el-col>
					<el-col :span="8">
					...
					<el-col :span="8">
						<el-form-item label="发票号码" prop="fapiaohaoma">
							<el-input class="list_inp" v-model="form.fapiaohaoma" placeholder="发票号码"
                                type="text"
								:readonly="!isAdd||disabledForm.fapiaohaoma?true:false" />
						</el-form-item>
					</el-col>
