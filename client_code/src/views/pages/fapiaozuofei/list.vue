    ...
    <div class="list-page">
		...
		<div class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" v-if="btnAuth('fapiaozuofei','新增')" @click="addClick">新增</el-button>
			</div>
		</div>
                ...
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="作废时间" :resizable='true' align="center" header-align="center">
							<template #default="scope">
