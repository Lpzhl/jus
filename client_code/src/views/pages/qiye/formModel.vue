	...
	<div class="detail-page">
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">企业电话</div>

					<div  class="info_text" >{{detail.qiyedianhua}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">统一社会信用代码</div>

					<div  class="info_text" >{{detail.tongyishehuixinyongdaima}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">行业类型</div>

					<div  class="info_text" >{{detail.xingyeleixing}}</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('qiye','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('qiye','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
	</div>
