    ...
    <div class="list-page">
		...
		<div class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" v-if="btnAuth('ziliaoguidang','新增')" @click="addClick">新增</el-button>
			</div>
		</div>
                ...
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="税务合同" :resizable='true' align="center" header-align="center">
							<template #default="scope">
								<el-button v-if="scope.row.shuiwuhetong" type="text" size="small" @click.stop="download(scope.row.shuiwuhetong)">下载</el-button>
								<el-button v-else disabled type="text" size="small">无</el-button>
							</template>
						</el-table-column>
						<el-table-column label="附件凭证" :resizable='true' align="center" header-align="center">
							<template #default="scope">
								<el-button v-if="scope.row.fujianpingzheng" type="text" size="small" @click.stop="download(scope.row.fujianpingzheng)">下载</el-button>
								<el-button v-else disabled type="text" size="small">无</el-button>
							</template>
						</el-table-column>
						...
						<el-table-column label="归档时间" :resizable='true' align="center" header-align="center">
							<template #default="scope">
