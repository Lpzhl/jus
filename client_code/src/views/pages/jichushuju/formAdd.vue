	...
	<div class="edit_view">
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="申报进度" prop="shenbaojindu">
						<el-select
							class="list_sel"
							:disabled="!isAdd||disabledForm.shenbaojindu?true:false"
							v-model="form.shenbaojindu" 
							placeholder="请选择申报进度"
							style="width:100%;"
							>
							<el-option v-for="(item,index) in shenbaojinduLists" :label="item"
								:value="item"
								>
							</el-option>
						</el-select>
