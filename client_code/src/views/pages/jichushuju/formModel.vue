	...
	<div class="detail-page">
		...
		<div class="detail_view">
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">申报进度</div>

					<div  class="info_text" >{{detail.shenbaojindu}}</div>
				</div>
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth('jichushuju','缴纳金额')" @click="shuikuanjiaonaonAcross('缴纳金额','是','','[1]','请勿重复操作')" type="warning">缴纳金额</el-button>
					<el-button class="cross_btn" v-if="btnFrontAuth('jichushuju','申报操作')" @click="shenbaocaozuoonAcross('申报操作','是','','shenbaojindu','已申报','已申报,未申报'.split(',')[0])" type="warning">申报操作</el-button>
					<el-button class="approval_btn" v-if="btnAuth('jichushuju','审核')&&detail.sfsh=='待审核'" type="warning" @click="approvalClick()">审核</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jichushuju','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jichushuju','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
