    ...
    <div class="list-page">
		...
		<div class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" v-if="btnAuth('shuiwuhuizongfenxi','新增')" @click="addClick">新增</el-button>
			</div>
		</div>
                ...
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="企业月度" :resizable='true' align="center" header-align="center">
							<template #default="scope">
								{{scope.row.qiyeyuedu}}
							</template>
						</el-table-column>
						<el-table-column label="申报通过率" :resizable='true' align="center" header-align="center">
							<template #default="scope">
