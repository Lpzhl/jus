	...
	<div class="detail-page">
		...
		<div class="detail_view">
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">操作时间</div>

					<div  class="info_text" >{{detail.caozuoshijian}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth('shenbaocaozuo','申报回执')" @click="shenbaohuizhionAcross('申报回执','','','','')" type="warning">申报回执</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('shenbaocaozuo','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('shenbaocaozuo','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
	</div>
