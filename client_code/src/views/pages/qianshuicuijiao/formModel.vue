	...
	<div class="detail-page">
		...
		<div class="detail_view">
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">催缴时间</div>

					<div  class="info_text" >{{detail.cuijiaoshijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">申报回执</div>
					<div class="info_text">
						<el-button class="info_down" v-if="detail.shenbaohuizhi" @click="downClick(detail.shenbaohuizhi)">点击下载</el-button>
						<el-button class="info_undown" v-else>暂无</el-button>
					</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('qianshuicuijiao','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('qianshuicuijiao','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
	</div>
