    ...
    <div class="list-page">
		...
		<div class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" v-if="btnAuth('qiyexiangqing','新增')" @click="addClick">新增</el-button>
			</div>
		</div>
                ...
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="税负异常" :resizable='true' align="center" header-align="center">
							<template #default="scope">
								{{scope.row.shuifuyichang}}
							</template>
						</el-table-column>
						<el-table-column label="逾期申报" :resizable='true' align="center" header-align="center">
							<template #default="scope">
								{{scope.row.yuqishenbao}}
							</template>
						</el-table-column>
						<el-table-column label="风险点" :resizable='true' align="center" header-align="center">
							<template #default="scope">
								{{scope.row.fengxiandian}}
							</template>
						</el-table-column>
						<el-table-column label="创建时间" :resizable='true' align="center" header-align="center">
							<template #default="scope">
