    ...
    <div class="list-page">
		...
		<div class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" v-if="btnAuth('fapiaolingyong','新增')" @click="addClick">新增</el-button>
			</div>
            <div class="chartBtn-row">
                <el-button class="chart_btn" type="warning" @click="echartClick1" v-if="btnAuth('fapiaolingyong','发票类型')">
                    发票类型
                </el-button>
            </div>
		</div>
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/fapiaolingyongAdd')
	}
	//判断是否从个人中心跳转
