...
public class ChathelperController {
    ...
    public R list( ChathelperEntity chathelper){
       	QueryWrapper<ChathelperEntity> ew = new QueryWrapper<ChathelperEntity>();
      	ew.allEq(MPUtil.allEQMapPre( chathelper, MPUtil.camelToSnake("chathelper")));
    ...
    public R info(@PathVariable("id") Long id){
		...
		chathelper = chathelperService.selectView(new QueryWrapper<ChathelperEntity>().eq("id", id));
        Map<String, String> deSens = new HashMap<>();
        //给需要脱敏的字段脱敏
