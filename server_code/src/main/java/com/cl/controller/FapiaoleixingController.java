 ...
 */
@RestController
@RequestMapping("/fapiaoleixing")
public class FapiaoleixingController {
    @Autowired
    private FapiaoleixingService fapiaoleixingService;
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,FapiaoleixingEntity fapiaoleixing,
        HttpServletRequest request){
        QueryWrapper<FapiaoleixingEntity> ew = new QueryWrapper<FapiaoleixingEntity>();



        PageUtils page = fapiaoleixingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, fapiaoleixing), params), params));
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,FapiaoleixingEntity fapiaoleixing,
		HttpServletRequest request){
        QueryWrapper<FapiaoleixingEntity> ew = new QueryWrapper<FapiaoleixingEntity>();
    ...
    public R list( FapiaoleixingEntity fapiaoleixing){
       	QueryWrapper<FapiaoleixingEntity> ew = new QueryWrapper<FapiaoleixingEntity>();
      	ew.allEq(MPUtil.allEQMapPre( fapiaoleixing, MPUtil.camelToSnake("fapiaoleixing")));
        return R.ok().put("data", fapiaoleixingService.selectListView(ew));
    }
    ...
    public R query(FapiaoleixingEntity fapiaoleixing){
        QueryWrapper< FapiaoleixingEntity> ew = new QueryWrapper< FapiaoleixingEntity>();
 		ew.allEq(MPUtil.allEQMapPre( fapiaoleixing, MPUtil.camelToSnake("fapiaoleixing")));
		FapiaoleixingView fapiaoleixingView =  fapiaoleixingService.selectView(ew);
		return R.ok("查询发票类型成功").put("data", fapiaoleixingView);
    }
    ...
    public R info(@PathVariable("id") Long id){
        FapiaoleixingEntity fapiaoleixing = fapiaoleixingService.getById(id);
		fapiaoleixing = fapiaoleixingService.selectView(new QueryWrapper<FapiaoleixingEntity>().eq("id", id));
        Map<String, String> deSens = new HashMap<>();
        //给需要脱敏的字段脱敏
        DeSensUtil.desensitize(fapiaoleixing,deSens);
        return R.ok().put("data", fapiaoleixing);
    }
    ...
    @RequestMapping("/save")
    @SysLog("新增发票类型")
    public R save(@RequestBody FapiaoleixingEntity fapiaoleixing, HttpServletRequest request){
        //ValidatorUtils.validateEntity(fapiaoleixing);
        fapiaoleixingService.save(fapiaoleixing);
        return R.ok().put("data",fapiaoleixing.getId());
    }
    ...
    @SysLog("新增发票类型")
    @RequestMapping("/add")
    public R add(@RequestBody FapiaoleixingEntity fapiaoleixing, HttpServletRequest request){
    	//ValidatorUtils.validateEntity(fapiaoleixing);
        fapiaoleixingService.save(fapiaoleixing);
        return R.ok();
    }
    ...
    @Transactional
    @SysLog("修改发票类型")
    public R update(@RequestBody FapiaoleixingEntity fapiaoleixing, HttpServletRequest request){
        //ValidatorUtils.validateEntity(fapiaoleixing);
        fapiaoleixingService.updateById(fapiaoleixing);//全部更新
        return R.ok();
    }
    ...
    public R delete(@RequestBody Long[] ids){
        fapiaoleixingService.removeBatchByIds(Arrays.asList(ids));
        return R.ok();
    }
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @RequestParam(required = false) String conditionColumn, @RequestParam(required = false) String conditionValue, @RequestParam(required = false, defaultValue = "总和") String func, HttpServletRequest request) throws IOException {
        ...
        List<Map<String, Object>> result = MPUtil.snakeListToCamel(fapiaoleixingService.selectValue(params, ew));
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType, @RequestParam(required = false) String conditionColumn, @RequestParam(required = false) String conditionValue, @RequestParam(required = false, defaultValue = "总和") String func, HttpServletRequest request) throws IOException {
        ...
        List<Map<String, Object>> result = MPUtil.snakeListToCamel(fapiaoleixingService.selectTimeStatValue(params, ew));
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName, @RequestParam(required = false) String conditionColumn, @RequestParam(required = false) String conditionValue, HttpServletRequest request) throws IOException {
        ...
        List<Map<String, Object>> result = MPUtil.snakeListToCamel(fapiaoleixingService.selectGroup(params, ew));
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,FapiaoleixingEntity fapiaoleixing, HttpServletRequest request){
        QueryWrapper<FapiaoleixingEntity> ew = new QueryWrapper<FapiaoleixingEntity>();
    long count = fapiaoleixingService.count(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, fapiaoleixing), params), params));
