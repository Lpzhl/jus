...
public class BaiduUtil {
    ...
    public static String qfChat(String msg) {
        String apiKey = ConfigUtil.getConfigValue("qf", "apiKey");
        String secretKey = ConfigUtil.getConfigValue("qf", "secretKey");
        Qianfan qianfan = new Qianfan(com.baidubce.qianfan.core.auth.Auth.TYPE_OAUTH, apiKey, secretKey);
        // 指定模型
