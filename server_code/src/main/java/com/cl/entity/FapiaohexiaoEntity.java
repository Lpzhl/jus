 ...
 */
@TableName("fapiaohexiao")
public class FapiaohexiaoEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public FapiaohexiaoEntity() {
		
	}
	
	public FapiaohexiaoEntity(T t) {
		try {
	 ...
	 * 设置：核销时间
	 */
	public void setHexiaoshijian(Date hexiaoshijian) {
		this.hexiaoshijian = hexiaoshijian;
	}
	/**
	 * 获取：核销时间
	 */
	public Date getHexiaoshijian() {
		return hexiaoshijian;
	}
	/**
	 * 设置：企业名称
	 */
