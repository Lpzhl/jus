...
public class JichushujuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JichushujuEntity() {
		
	}
	
	public JichushujuEntity(T t) {
		try {
	 ...
	 * 设置：申报进度
	 */
	public void setShenbaojindu(String shenbaojindu) {
		this.shenbaojindu = shenbaojindu;
	}
	/**
	 * 获取：申报进度
	 */
	public String getShenbaojindu() {
		return shenbaojindu;
	}
